...
<?php
$enable_content = get_theme_mod( 'catch_mag_featured_content_option', 'disabled' );
...
if ( ! catch_mag_check_section( $enable_content ) ) {
	...
	$featured_posts = catch_mag_get_posts( 'featured_content' );

	if ( empty( $featured_posts ) ) {
		return;
	}

	$title     = get_option( 'featured_content_title', esc_html__( 'Contents', 'catch-mag' ) );
