...
if ( ! function_exists( 'catch_mag_featured_image' ) ) :
	/**
	 * Template for Featured Header Image from theme options
	 *
	 * To override this in a child theme
	 * simply create your own catch_mag_featured_image(), and that function will be used instead.
	 *
	 * @since Catch Base 1.0
	 */
	function catch_mag_featured_image() {
				...
				<div class="header-media section">
					<div class="wrapper">
						<div class="post-thumbnail archive-header-image">
							<?php echo wp_get_attachment_image( (int) $jetpack_options['featured-image'], 'catch-mag-slider' ); ?>
						</div>
					</div><!-- .wrapper -->
				</div><!-- .header-media -->
			<?php endif;
		...
		elseif ( is_post_type_archive( 'jetpack-portfolio' ) || is_post_type_archive( 'featured-content' ) || is_post_type_archive( 'ect-service' ) ) :
			...
			if ( '' !== $featured_image ) : ?>
				<div class="header-media section">
					<div class="wrapper">
						<div class="post-thumbnail archive-header-image">
							<?php echo wp_get_attachment_image( (int) $featured_image, 'catch-mag-slider' ); ?>
						</div>
					</div><!-- .wrapper -->
				</div><!-- .header-media -->
...
if ( ! function_exists( 'catch_mag_featured_page_post_image' ) ) :
	/**
