<?php
/**
 * Catch Magazine Theme Options Sanitization Functions
 *
 * @package Catch_Mag
 */
 ...
 */
function catch_mag_sanitize_select( $input, $setting ) {
 ...
 */
function catch_mag_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 */
function catch_mag_sanitize_post( $input ) {
 ...
 */
function catch_mag_sanitize_image( $image, $setting ) {
    /*
 ...
 * @since Catch Mag 1.0
 */
function catch_mag_sanitize_category_list( $input ) {
 ...
 *                    the setting default.
 */
function catch_mag_sanitize_number_range( $number, $setting ) {
