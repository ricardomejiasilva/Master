...
*/
 jQuery(document).ready(function($) {
    $('#customize-control-theme_options-layout_options_blog #creativ-mag-img-container li label img').click(function(){    	
        $('#customize-control-theme_options-layout_options_blog #creativ-mag-img-container li').each(function(){
            $(this).find('img').removeClass ('creativ-mag-radio-img-selected') ;
        });
        $(this).addClass ('creativ-mag-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_archive #creativ-mag-img-container li label img').click(function(){    	
        $('#customize-control-theme_options-layout_options_archive #creativ-mag-img-container li').each(function(){
            $(this).find('img').removeClass ('creativ-mag-radio-img-selected') ;
        });
        $(this).addClass ('creativ-mag-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_page #creativ-mag-img-container li label img').click(function(){    	
        $('#customize-control-theme_options-layout_options_page #creativ-mag-img-container li').each(function(){
            $(this).find('img').removeClass ('creativ-mag-radio-img-selected') ;
        });
        $(this).addClass ('creativ-mag-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_single #creativ-mag-img-container li label img').click(function(){    	
        $('#customize-control-theme_options-layout_options_single #creativ-mag-img-container li').each(function(){
            $(this).find('img').removeClass ('creativ-mag-radio-img-selected') ;
        });
        $(this).addClass ('creativ-mag-radio-img-selected') ;
    });         
