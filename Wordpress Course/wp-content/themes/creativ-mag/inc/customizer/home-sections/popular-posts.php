...
$wp_customize->add_section( 'section_home_popular_posts',
	array(
		'title'      => __( 'Popular Posts', 'creativ-mag' ),
		'priority'   => 100,
...
// Disable Popular Posts Section
$wp_customize->add_setting('theme_options[disable_popular_posts_section]', 
	array(
	'default' 			=> $default['disable_popular_posts_section'],
	'type'              => 'theme_mod',
	'capability'        => 'edit_theme_options',
...
$wp_customize->add_control('theme_options[disable_popular_posts_section]', 
	array(		
	'label' 	=> __('Enable Popular Posts Section', 'creativ-mag'),
	'section' 	=> 'section_home_popular_posts',
	'settings'  => 'theme_options[disable_popular_posts_section]',
	'type' 		=> 'checkbox',	
	)
);
...
$wp_customize->add_control('theme_options[popular_posts_section_title]', 
	...
	'active_callback' => 'creativ_mag_popular_posts_active',		
	'type'        => 'text'
	)
);
...
$wp_customize->add_control('theme_options[number_of_popular_items]', 
	...
	'description' => __('Save & Refresh the customizer to see its effect. Maximum is 5.', 'creativ-mag'),
	'section'     => 'section_home_popular_posts',   
...
$wp_customize->add_setting('theme_options[popular_content_type]', 
	array(
	'default' 			=> $default['popular_content_type'],
	'type'              => 'theme_mod',
	'capability'        => 'edit_theme_options',	
...
$wp_customize->add_control('theme_options[popular_content_type]', 
	array(
	'label'       => __('Content Type', 'creativ-mag'),
	'section'     => 'section_home_popular_posts',   
	'settings'    => 'theme_options[popular_content_type]',		
	'type'        => 'select',
	'active_callback' => 'creativ_mag_popular_posts_active',
	'choices'	  => array(
...
$number_of_popular_items = creativ_mag_get_option( 'number_of_popular_items' );
...
for( $i=1; $i<=$number_of_popular_items; $i++ ){
	...
	$wp_customize->add_control('theme_options[popular_posts_page_'.$i.']', 
		...
		'type'        => 'dropdown-pages',
		'active_callback' => 'creativ_mag_popular_posts_page',
		)
	);
	...
	$wp_customize->add_control('theme_options[popular_posts_post_'.$i.']', 
		...
		'active_callback' => 'creativ_mag_popular_posts_post',
		)
	);
}