let GameManager = {
  ...
  setFight: function() {
    ...
    //create enemy!
    let enemy00 = new Enemy("Goblin", 100, 0, 20, 100, 100)
    let enemy01 = new Enemy("Troll", 200, 0, 150, 80, 150)
    let chooseRadomEnemy = Math.floor(Math.random() * Math(2)) 
    switch (chooseRadomEnemy) {
      case 0:
        enemy = enemy00
        break
      case 1:
...
//     let chooseRadomEnemy = Math.floor(Math.random() * Math.floor(2));
//     switch (chooseRadomEnemy) {
//       case 0:
//         enemy = enemy00
//         break;
